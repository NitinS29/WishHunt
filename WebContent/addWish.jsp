...
<div class="col-lg-8">
	<section id="content" class="addWish">
		...
		<form class="form-horizontal" action="addWish" method="POST">
		<input type="hidden" name="action" value="addWish" />
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="wishTitle">Wish Title:</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" required name="wishTitle" id="wishTitle" placeholder="Enter title">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="wishDescription">Wish Description:</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" required name="wishDescription" id="wishDescription" placeholder="Enter description">
		    </div>
		  </div>
		  <div class="form-group">
